#ifndef TASTY_INT_TASTY_INT_DETAIL_BASE_PREFIX_FROM_STRING_HPP
#define TASTY_INT_TASTY_INT_DETAIL_BASE_PREFIX_FROM_STRING_HPP
...
#endif // ifndef TASTY_INT_TASTY_INT_DETAIL_BASE_PREFIX_FROM_STRING_HPP
