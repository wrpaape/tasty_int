#ifndef TASTY_INT_TASTY_INT_DETAIL_CODE_GENERATOR_TEST_TABLE_GENERATOR_TEST_FIXTURE_HPP
#define TASTY_INT_TASTY_INT_DETAIL_CODE_GENERATOR_TEST_TABLE_GENERATOR_TEST_FIXTURE_HPP
 ...
 * tasty_int::detail::code_generator::TableGenerator against an expected
 * configuration.
 */
class TableGeneratorTestFixture : public ::testing::Test
{
protected:
    using TableGenerator = tasty_int::detail::code_generator::TableGenerator;
...
#endif // ifndef TASTY_INT_TASTY_INT_DETAIL_CODE_GENERATOR_TEST_TABLE_GENERATOR_TEST_FIXTURE_HPP
