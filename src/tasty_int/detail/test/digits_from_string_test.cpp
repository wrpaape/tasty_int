...
struct InvalidTokenTestParam : public FromStringTestParam
{
...
TEST_P(InvalidTokenTest, InvalidTokenThrowsInvalidArgument)
{
    ...
    try {
        ...
        std::ostringstream expected_message;
        expected_message <<
            "tasty_int::detail::digits_from_string - invalid token ('"
...
{
    static const std::vector<FromStringTestParam> test_parameters = {
