...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(need_stash)
      execute_process(
        COMMAND "/usr/local/bin/git" stash save --quiet
        WORKING_DIRECTORY "/Users/Reid/my_projects/cpp/tasty_int/test/src/googletest"
        RESULT_VARIABLE error_code
        )
      if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/Reid/my_projects/cpp/tasty_int/test/src/googletest/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/Reid/my_projects/cpp/tasty_int/test/src/googletest/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
