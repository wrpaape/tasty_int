...
if("/Users/Reid/my_projects/cpp/tasty_int/cmake/Unity-prefix/src/Unity-stamp/Unity-gitinfo.txt" IS_NEWER_THAN "/Users/Reid/my_projects/cpp/tasty_int/cmake/Unity-prefix/src/Unity-stamp/Unity-gitclone-lastrun.txt")
  set(run 1)
endif()

if(NOT run)
  message(STATUS "Avoiding repeated git clone, stamp file is up to date: '/Users/Reid/my_projects/cpp/tasty_int/cmake/Unity-prefix/src/Unity-stamp/Unity-gitclone-lastrun.txt'")
  return()
endif()
...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E copy
    "/Users/Reid/my_projects/cpp/tasty_int/cmake/Unity-prefix/src/Unity-stamp/Unity-gitinfo.txt"
    "/Users/Reid/my_projects/cpp/tasty_int/cmake/Unity-prefix/src/Unity-stamp/Unity-gitclone-lastrun.txt"
  WORKING_DIRECTORY "/Users/Reid/my_projects/cpp/tasty_int/test/src/Unity"
  RESULT_VARIABLE error_code
  )
if(error_code)
  message(FATAL_ERROR "Failed to copy script-last-run stamp file: '/Users/Reid/my_projects/cpp/tasty_int/cmake/Unity-prefix/src/Unity-stamp/Unity-gitclone-lastrun.txt'")
endif()
